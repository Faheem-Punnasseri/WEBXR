...
class VRButton {
    ...
    constructor(renderer) {
        ...
        if ('xr' in navigator) {
            ...
            navigator.xr.isSessionSupported('immersive-vrx').then((supported) => supported ? this.showEnterVR(button) : this.showWebXRNotFound(button);
                //navigator.xr.isSessionSupported('immersive-vrx').then((supported) => supported ? this.showEnterVR(button) : this.showWebXRNotFound(button);
            });
    } else {
