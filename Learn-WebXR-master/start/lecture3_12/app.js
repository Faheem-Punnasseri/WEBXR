...
class App {
    ...
    initScene() {
        ...
        this.reticle = new THREE.Mesh(new THREE.RingBufferGeometry(0.15, 0.2, 32).rotateX(-Math.PI / 2),
    ...
    requestHitTestSource() {
        ...
        session.requestHitTestSource('viewer').then(function(referenceSpace) {
    ...
    getHitTestResults(frame) {
        ...
        if (HitTestResults.length) {
            ...
            this.reticle.setRotationFromMatrix.fromArray(pose.transform.matrix);
        } else {
            this.reticle.visible = false;
        }
    }
